    ...
    $.fn.beefup = function(options) {
        ...
        this.click = function($el) {
            ...
            if (vars.openSingle) {
                if (vars.stayOpen !== null) {
                    $obj.close(
                        $obj.not($el).not(beefup.methods.getStayOpen($obj, vars.stayOpen))
                    );
                } else {
        ...
        return this.each(function(index, el) {
            ...
            if (
                vars.stayOpen !== null &&
                $el.is(beefup.methods.getStayOpen($obj, vars.stayOpen))
            ) {
                $el.addClass(vars.openClass);
            }

            $el.not('.' + vars.openClass)
                .find(vars.content + ':first')
                .hide();
