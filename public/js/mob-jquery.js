        ...
        base = {
            ...
            element: function() {
                if (!(baseElement && baseElement.length)) {
                    baseElement = $('<base>', {
                        href: $.mobile.path.documentBase.hrefNoSearch
                    }).prependTo($('head'));
                }
    ...
    (function($, window, undefined) {
        ...
        $.extend($.mobile, {
            ...
            getClosestBaseUrl: function(ele) {
                ...
                if (
                    !$.mobile.base.dynamicBaseEnabled ||
                    !url ||
    ...
    (function($, undefined) {
        ...
        $.mobile._registerInternalEvents = function() {
            var getAjaxFormData = function($form, calculateOnly) {
                ...
                if (
                    path.isExternal(url) &&
                    !path.isPermittedCrossDomainRequest(documentUrl, url)
                ) {
                    return false;
                }
            ...
            $.mobile.document.bind('click', function(event) {
                ...
                isExternal =
                    useDefaultUrlHandling ||
                    (path.isExternal(href) &&
                        !path.isPermittedCrossDomainRequest(documentUrl, href));
                        ...
                        for (pos = 0, numli = li.length; pos < numli; pos++) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    icon =
                                        itemIcon === false ? false : itemIcon || o.icon;
            ...
            $.extend(
                {
                    ...
                    refresh: function(val, isfromControl, preventInputUpdate) {
                        ...
                        if (this._labels) {
                            handlePercent =
                                (this.handle.width() / this.slider.width()) * 100;
                            aPercent =
                                percent &&
            ...
            $.extend(
                {
                    ...
                    _dragFirstHandle: function(event) {
                        ...
                        $.data(this._inputFirst.get(0), 'mobile-slider')._trigger(
                            'start'
                        );
                        return false;
                    },
    ...
    (function($, undefined) {
        $.widget(
            ...
            $.extend(
                {
                    ...
                    _preExtension: function() {
                        var inline =
                                this.options.inline || this.element.jqmData('inline'),
			...
			classes = $el[0].className;
                        ...
                        this.label = $(
                            "label[for='" +
                                $.mobile.path.hashToSelector(this.selectId) +
                                "']"
                        );
            ...
            _handleWindowResize: function(/* theEvent */) {
                if (this._isOpen && this._ignoreResizeTo === 0) {
                    if (
                        isOutOfSight(
                            this._ui.container,
                            getWindowCoordinates(this.window)
                        ) &&
			...
			*/
            ...
            _closePopup: function(theEvent, data) {
                ...
                if (theEvent && theEvent.type === 'pagebeforechange' && data) {
                    ...
                    if (
                        this._myUrl !== $.mobile.path.makeUrlAbsolute(toUrl) ||
        ...
        $.widget('mobile.selectmenu', $.mobile.selectmenu, {
            ...
            build: function() {
                ...
                listbox = $(
                    ...
                    .popup();
                list = $(
                    "<ul class='ui-selectmenu-list' role='listbox' aria-labelledby='" +
                        this.buttonId +
                        "'" +
                        themeAttr +
                        dividerThemeAttr +
            ...
            $.widget('mobile.toolbar', $.mobile.toolbar, {
                ...
                _handlePageFocusinFocusout: function(event) {
                    ...
                    if (
                        ...
                        !$(event.target).closest('.ui-header-fixed, .ui-footer-fixed')
                            .length
                    ) {
                    ...
                    var self = this,
                        ...
                        _openPanel = function() {
                            ...
                            if (!immediate && $.support.cssTransform3d && !!o.animate) {
                                (self._wrapper || self.element).animationComplete(
                                    complete,
                                    'transition'
                                );
                            } else {
